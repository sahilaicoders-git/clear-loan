  ...
  return (
    <div className="relative pt-32 pb-16 px-4 z-0 min-h-screen">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-lg h-[400px] opacity-40 dark:opacity-20 pointer-events-none -z-10 transition-opacity duration-1000">
        <div className="absolute top-20 left-10 w-64 h-64 bg-indigo-400 dark:bg-indigo-600 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[100px] animate-blob" />
        <div className="absolute top-20 right-10 w-64 h-64 bg-purple-300 dark:bg-purple-600 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[100px] animate-blob animation-delay-2000" />
      </div>
      ...
      <div className="bg-white/80 dark:bg-[#18181b]/80 backdrop-blur-2xl p-8 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none border border-white dark:border-white/5 w-full max-w-md relative z-10 mx-auto mt-12 transition-colors">
        <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-2 tracking-tight transition-colors">Welcome back.</h2>
        <p className="text-gray-500 dark:text-gray-400 mb-8 font-medium transition-colors">Log in to sync your financial model data.</p>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-gray-900 dark:bg-white text-white dark:text-gray-900 py-3.5 rounded-xl font-bold hover:bg-gray-800 dark:hover:bg-gray-200 transition-transform active:scale-95 flex items-center justify-center gap-2 mt-4"
          >
